...
create_docker_compose() {
  ...
  echo "    container_name: ${app_name}-app" >> docker-compose.yaml
  echo "    image: ${app_name}-app" >> docker-compose.yaml
  ...
  if [[ ${selected[2]} == 1 ]]; then
    ...
    echo "    container_name: pgadmin4" >> docker-compose.yaml
    echo "    restart: always" >> docker-compose.yaml
    echo "    ports:" >> docker-compose.yaml
    # shellcheck disable=SC2016
